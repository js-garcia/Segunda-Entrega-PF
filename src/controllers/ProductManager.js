...
const p1 = new Product ("conejo-1","Animalito Tejido Mini",1900,"#121",5,"M/Mi",true,[]);
const p2 = new Product ("dino-2","Animalito Tejido Mediano",2300,"#122",8,"M/M",true,[]);
const p3 = new Product ("sirena-3","Muñeca Tejida Grande",2800,"#123",7,"M/G",true,[]);
const p4 = new Product ("zorrito-4","Muñeco Tejido XL",3500,"#124",6,"M/XL",true,[]);
...
export class ProductManager {
    ...
    await this.addProduct(p1, ['../public/img/conejo.jpg']);
    await this.addProduct(p2, ['../public/img/dino.jpg']);
    await this.addProduct(p3, ['../public/img/sirena.jpg']);
    await this.addProduct(p4, ['../public/img/zorrito.jpg']);
    }
}
