...
export class ProductManager {
    ...
    async createJson() {
      ...
      /*async function createProducts() {
        const products = [
          { name: p1, images: ['../public/img/Sirena.jpg'] },
          { name: p2, images: ['../public/img/12-aireacondicionado.jpg'] },
          { name: p3, images: ['../public/img/12-aireacondicionado.jpg'] },
          { name: p4, images: ['../public/img/12-aireacondicionado.jpg'] }
        ];
      
        for (const product of products) {
          await this.addProduct(product.name, product.images);
        }
      }*/
}